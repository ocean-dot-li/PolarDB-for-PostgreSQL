...
`)])])],-1),E=p(`<p>源码下载完毕后，使用 <code>sudo</code> 执行源代码根目录下的依赖安装脚本 <code>install_dependencies.sh</code> 自动完成所有的依赖安装。如果有定制的开发需求，请自行修改 <code>install_dependencies.sh</code>。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> PolarDB-for-PostgreSQL
<span class="token function">sudo</span> ./install_dependencies.sh
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function P(R,D){const e=l("ExternalLinkIcon"),t=l("CodeGroupItem"),i=l("CodeGroup");return c(),d("div",null,[v,u,s("p",null,[n("我们在 DockerHub 上提供了构建完毕的镜像 "),s("a",b,[k,a(e)]),n(" 可供直接使用（支持 AMD64 和 ARM64 架构）😁。")]),g,s("p",null,[n("PolarDB for PostgreSQL 的代码托管于 "),s("a",h,[n("GitHub"),a(e)]),n(" 上，稳定分支为 "),f,n("。如果因网络原因不能稳定访问 GitHub，则可以访问 "),s("a",_,[n("Gitee 国内镜像"),a(e)]),n("。")]),a(i,null,{default:o(()=>[a(t,{title:"GitHub"},{default:o(()=>[S]),_:1}),a(t,{title:"Gitee 国内镜像"},{default:o(()=>[y]),_:1})]),_:1}),E])}const L=r(m,[["render",P],["__file","customize-dev-env.html.vue"]]);export{L as default};
